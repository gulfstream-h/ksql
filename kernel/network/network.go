...
// PerformSelect is used for long-living select queries
// ksql requires asking websocket route for all selects
...
// it can be used for show, describe, drop, create, insert
